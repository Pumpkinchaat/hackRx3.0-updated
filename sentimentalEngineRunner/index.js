...
const { unProcessedReviewSchema, processedReviewSchema } = require("./model");
...
const connectDB = async () => {
  ...
  return { UnProcessedReview, ProcessedReview };
};

const main = async () => {
  //try connecting the DB
  try {
    const { UnProcessedReview, ProcessedReview } = await connectDB();
    console.log(
